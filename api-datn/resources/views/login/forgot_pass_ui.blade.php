...
<head>
  ...
  <title>Quên mật khẩu | TLU Graduation Project</title>
...
<body class="min-h-screen bg-gradient-to-br from-sky-200 via-sky-300 to-sky-400 flex items-center justify-center p-4">
  ...
  <div class="w-full max-w-md">
    <div class="bg-white/90 backdrop-blur rounded-2xl shadow-2xl overflow-hidden">
      <div class="px-8 pt-8 text-center">
        ...
        <p class="text-slate-500 text-sm mt-1">Quên mật khẩu</p>
      </div>

      <div class="p-8">
        <form method="POST" action="{{ url('/forgot-password') }}" class="space-y-5" id="forgotForm">
          @csrf
          ...
          <div class="flex items-center justify-between">
            ...
            <a href="{{ route('web.auth.login') }}" class="text-sky-700 hover:text-sky-900 text-sm font-medium">Quay lại đăng nhập</a>
          </div>
  ...
  <script>
    ...
    // Lưu/khôi phục email vào localStorage (đồng bộ với login)
