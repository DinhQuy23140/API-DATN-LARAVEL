        ...
        <div class="max-w-6xl mx-auto space-y-6">
          <section class="bg-white rounded-xl border border-slate-200 p-5">
            <div class="flex items-center justify-between gap-3 flex-wrap">
              <div>
                <div class="text-sm text-slate-500">Đợt hiện tại: <span class="font-medium text-slate-700">HK1
                    2025-2026</span></div>
              ...
              <div class="flex items-center gap-2">
                <div class="relative">
                  ...
                  <div id="profileMenu"
                    ...
                    <a href="#" class="flex items-center gap-2 px-3 py-2 hover:bg-slate-50"><i
                        class="ph ph-user"></i>Xem thông tin</a>
