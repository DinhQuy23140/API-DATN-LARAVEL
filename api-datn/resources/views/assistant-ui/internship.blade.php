...
<html lang="vi">
  <head>
    ...
    <title>Thực tập tốt nghiệp - Trợ lý khoa</title>
      ...
      <div class="flex-1">
        <header class="fixed left-0 md:left-[260px] right-0 top-0 h-16 bg-white border-b border-slate-200 flex items-center px-4 md:px-6 z-20">
          <div class="flex items-center gap-3 flex-1">
            ...
            <div>
              <h1 class="text-lg md:text-xl font-semibold">Thực tập tốt nghiệp</h1>
              <nav class="text-xs text-slate-500 mt-0.5">Trang chủ / Trợ lý khoa / Học phần tốt nghiệp / Thực tập tốt nghiệp</nav>
            </div>
          </div>
          <div class="relative">
        ...
        <main class="pt-20 px-4 md:px-6 pb-10">
          <div class="max-w-6xl mx-auto space-y-6">
            <section class="bg-white rounded-xl border border-slate-200 p-5">
              <h2 class="font-semibold">Quản lý thực tập</h2>
              <p class="text-sm text-slate-600 mt-2">Trang placeholder cho Thực tập tốt nghiệp. Bạn có thể thêm danh sách đợt thực tập, sinh viên, doanh nghiệp, v.v.</p>
            </section>
          </div>
        </main>
      </div>
