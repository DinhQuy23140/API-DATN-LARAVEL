          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <section class="lg:col-span-1 bg-white rounded-xl border border-slate-200 p-4">
              <div class="relative">
                ...
                <div id="profileMenu"
                  ...
                  <a href="#" class="flex items-center gap-2 px-3 py-2 hover:bg-slate-50"><i class="ph ph-user"></i>Xem
                    thông tin</a>
            ...
            <section class="lg:col-span-2 space-y-4">
              <div id="progressDetail"
                class="bg-white rounded-xl border border-slate-200 p-4 min-h-[420px] grid place-items-center text-slate-500">
