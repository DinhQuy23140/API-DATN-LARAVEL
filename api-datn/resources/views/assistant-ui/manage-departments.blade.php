...
<html lang="vi">
    ...
    <div class="flex min-h-screen">
      <aside id="sidebar" class="sidebar fixed inset-y-0 left-0 z-30 bg-white border-r border-slate-200 flex flex-col transition-all">
        ...
        <nav class="flex-1 overflow-y-auto p-3">
          ...
          <a href="{{ route('web.assistant.manage_departments') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-100 font-semibold"><i class="ph ph-buildings"></i><span class="sidebar-label">Bộ môn</span></a>
  ...
  <main class="pt-20 px-4 md:px-6 pb-10 space-y-5">
          ...
          <div class="bg-white border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
            <div class="relative w-full sm:max-w-sm">
              <input id="searchInput" class="w-full pl-9 pr-3 py-2.5 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 text-sm" placeholder="Tìm theo mã hoặc tên bộ môn" />
              <i class="ph ph-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400"></i>
            </div>
            <button onclick="openModal('add')" class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700"><i class="ph ph-plus"></i>Thêm bộ môn</button>
          </div>
  ...
  <th class="py-3 px-4 border-b">Số giảng viên</th>
        ...
        <td class="py-3 px-4">D-CNTT</td>
                    <td class="py-3 px-4">Công nghệ thông tin</td>
  <td class="py-3 px-4"><a class="text-blue-600 hover:underline" href="../lecturer-ui/profile.html">TS. Đặng Hữu T</a></td>
  <td class="py-3 px-4">KTPM, KHMT</td>
                  ...
                  <tr class="hover:bg-slate-50">
        <td class="py-3 px-4"><input type="checkbox" class="rowChk h-4 w-4"/></td>
        <td class="py-3 px-4">D-MKT</td>
                    <td class="py-3 px-4">Marketing</td>
  <td class="py-3 px-4"><a class="text-blue-600 hover:underline" href="../lecturer-ui/profile.html">ThS. Lưu Lan</a></td>
  <td class="py-3 px-4">MKT</td>
    ...
    <div id="modal" class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm hidden items-center justify-center z-50">
      <div class="bg-white rounded-xl w-full max-w-lg shadow-xl">
        <div class="p-4 border-b flex items-center justify-between">
          <h3 id="modalTitle" class="font-semibold">Thêm bộ môn</h3>
        ...
        <form class="p-4 space-y-4" onsubmit="event.preventDefault(); closeModal();">
          <div>
            <label class="text-sm font-medium">Mã bộ môn</label>
            <input required class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600" placeholder="VD: D-CNTT" />
          </div>
          <div>
            <label class="text-sm font-medium">Tên bộ môn</label>
            <input required class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600" placeholder="VD: Công nghệ thông tin" />
          </div>
          <div>
            <label class="text-sm font-medium">Trưởng bộ môn</label>
          ...
          <div>
            <label class="text-sm font-medium">Ngành thuộc bộ môn</label>
            <input class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200" placeholder="VD: KTPM, KHMT" />
          </div>
