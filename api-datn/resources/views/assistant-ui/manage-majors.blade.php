  ...
  <body class="bg-slate-50 text-slate-800">
    <aside id="sidebar" class="fixed inset-y-0 left-0 top-0 z-30 bg-white border-r border-slate-200 flex flex-col">
      ...
      <nav class="flex-1 overflow-y-auto p-3">
        ...
        <a href="{{ route('web.assistant.manage_majors') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-100 font-semibold"><i class="ph ph-book-open-text"></i><span class="sidebar-label">Ngành</span></a>
        ...
        <section class="bg-white rounded-xl border border-slate-200 p-5 mb-6">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
              <div class="relative">
                <input id="searchInput" class="pl-9 pr-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 text-sm" placeholder="Tìm theo mã hoặc tên ngành" />
                <i class="ph ph-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400"></i>
              </div>
              <button id="btnAdd" class="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 text-sm flex items-center gap-2"><i class="ph ph-plus"></i> Thêm ngành</button>
            </div>
          </div>
        </section>
            ...
            <table class="w-full text-sm">
              ...
              <tbody id="tableBody">
                <tr class="hover:bg-slate-50">
                  ...
                  <td class="py-3 px-4"><a class="text-blue-600 hover:underline" href="manage-departments.html">CNTT</a></td>
                  <td class="py-3 px-4 text-right space-x-2">
                    <button class="px-3 py-1.5 rounded-lg border hover:bg-slate-50 text-slate-600" onclick="openModal('edit','MJ-SE','Kỹ thuật phần mềm','CNTT')"><i class="ph ph-pencil"></i></button>
                ...
                <tr class="hover:bg-slate-50">
                  ...
                  <td class="py-3 px-4"><a class="text-blue-600 hover:underline" href="manage-departments.html">Marketing</a></td>
                  <td class="py-3 px-4 text-right space-x-2">
                    <button class="px-3 py-1.5 rounded-lg border hover:bg-slate-50 text-slate-600" onclick="openModal('edit','MJ-MKT','Marketing','Marketing')"><i class="ph ph-pencil"></i></button>
                    <button class="px-3 py-1.5 rounded-lg border hover:bg-slate-50 text-rose-600" onclick="deleteRow(this)"><i class="ph ph-trash"></i></button>
                  </td>
                </tr>
              </tbody>
      ...
      <div class="bg-white rounded-xl w-full max-w-lg shadow-xl">
        ...
        <form id="modalForm" class="p-4 space-y-4" onsubmit="event.preventDefault(); saveMajor();">
          <div>
            ...
            <input id="inputCode" required class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600" placeholder="VD: MJ-SE" />
          </div>
          <div>
            <label class="text-sm font-medium">Tên ngành</label>
            <input id="inputName" required class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600" placeholder="VD: Kỹ thuật phần mềm" />
          </div>
          <div>
            <label class="text-sm font-medium">Bộ môn phụ trách</label>
            <select id="inputDept" class="mt-1 w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600">
