...
<body class="bg-slate-50 text-slate-800">
    ...
    <div class="flex-1 h-screen overflow-hidden flex flex-col">
      ...
      <main class="flex-1 overflow-y-auto px-4 md:px-6 py-6">
        <div class="max-w-5xl mx-auto space-y-4">
          <a id="backLink" href="javascript:history.back()" class="text-sm text-blue-600 hover:underline"><i class="ph ph-caret-left"></i> Quay lại</a>
          ...
          <section class="bg-white border rounded-xl p-4">
            ...
            <div class="mt-4 flex items-center gap-2">
              <button id="saveBtn" class="px-3 py-2 bg-blue-600 text-white rounded text-sm"><i class="ph ph-floppy-disk"></i> Lưu phiếu chấm</button>
  ...
  <script>
    ...
    const STORAGE_KEY = `defense_student_${studentId}`;
    function loadData(){
    ...
    document.getElementById('saveBtn').addEventListener('click', ()=>{
      ...
      // Optional: sync to a list for committee
      try {
        const listKey = `defense_committee_${committeeId}`;
