        ...
        <div class="flex items-center gap-3 flex-1">
          ...
          <div>
            ...
            <nav class="text-xs text-slate-500 mt-0.5">
              ...
              <span class="mx-1">/</span>
              <span class="text-slate-500">Danh sách sinh viên chấm bảo vệ đồ án</span>
            </nav>
          </div>
        </div>
        <div class="relative">
                ...
                <tbody id="rows">
                  @foreach ($council_projects as $council_project)
                    @php
                      ...
                      $reportUrl = $council_project->assignment->project?->reportFiles?->sortByDesc('created_at')->where('type_report', 'report')->first()?->file_url
