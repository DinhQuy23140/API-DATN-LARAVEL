...
<head>
  ...
  <title>Tra cứu danh sách hội đồng</title>
    ...
    <div class="flex-1 h-screen overflow-hidden flex flex-col">
      <header class="h-16 bg-white border-b border-slate-200 flex items-center px-4 md:px-6 flex-shrink-0">
        <div class="flex items-center gap-3 flex-1">
          ...
          <div>
            <h1 class="text-lg md:text-xl font-semibold">Tra cứu danh sách hội đồng</h1>
            <nav class="text-xs text-slate-500 mt-0.5">
              ...
              <span class="mx-1">/</span>
              <span class="text-slate-500">Tra cứu hội đồng</span>
            </nav>
          </div>
        </div>
        <div class="relative">
        ...
        <div class="max-w-6xl mx-auto space-y-4">
          <div class="flex items-center justify-between">
            <div class="relative">
              ...
              <input id="searchInput" class="pl-8 pr-3 py-2 border border-slate-200 rounded text-sm w-80" placeholder="Tìm theo mã hội đồng/tên hội đồng/giảng viên" />
            </div>
  ...
  <script>
    ...
    const committees = [
      {
        ...
        date: '20/08/2025', time: '08:00', room: 'P.A203',
        members: [
          { role: 'Chủ tịch', name: 'PGS.TS. Trần Văn B' },
          { role: 'Ủy viên', name: 'TS. Lê Thị C' },
          { role: 'Ủy viên', name: 'TS. Phạm Văn D' },
      ...
      {
        id: 'CNTT-02',
        name: 'Hội đồng CNTT-02',
        date: '20/08/2025', time: '09:30', room: 'P.A204',
        members: [
          { role: 'Chủ tịch', name: 'TS. Phạm Văn D' },
          { role: 'Ủy viên', name: 'TS. Lê Thị C' },
          { role: 'Ủy viên', name: 'ThS. Trần Thị F' },
          { role: 'Thư ký', name: 'ThS. Nguyễn Văn G' },
          { role: 'Phản biện', name: 'TS. Nguyễn Thị E' }
        ]
      }
    ...
    function render(list){
      ...
      wrap.innerHTML = list.map(c=>`
        <div id="${c.id}" class="bg-white border rounded-xl p-4">
          <div class="flex items-center justify-between">
            <div>
            ...
            <a class="px-3 py-1.5 border border-slate-200 rounded text-sm" href="thesis-round-detail.html">Về đợt</a>
          </div>
          <div class="mt-3">
    ...
    if(location.hash){ const el = document.getElementById(location.hash.substring(1)); if(el) el.scrollIntoView({behavior:'smooth'}); }
  </script>
</body>
</html>
